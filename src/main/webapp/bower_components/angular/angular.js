 ...
 *   dialog and avoiding unnecessary browser repaints, which would result in flickering UI.
 ...
 * ## Animation Hooks
 *
 * Animations within dialog are triggered when any of the associated CSS classes are added and removed
